...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {
        ...
        $sql = "UPDATE user SET first_name = '$first_name', last_name = '$last_name', email = '$email', phone_number = '$phone_number', address = '$address', picture = '$pictureArray->fileName' WHERE id = {$id}";
    } else {
        $sql = "UPDATE user SET first_name = '$first_name', last_name = '$last_name', email = '$email', phone_number = '$phone_number', address = '$address' WHERE id = {$id}";
    }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="d-flex align-items-center ">
                    <img class="userHome" style=" width: 25px;" src="pictures/<?php echo $picture ?>" alt="<?php echo $first_name ?>">
                    <p class="text-dark ms-2 pt-3">Hi <?php echo $first_name ?></p>
                </li>
