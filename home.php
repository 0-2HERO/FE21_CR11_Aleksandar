...
if (mysqli_num_rows($result)  > 0) {
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        <div class='lc-block border rounded shadow'>
           ...
           <a href='details.php?id=" . $row['id'] . "'><button class='btn btn-outline-primary m-1 rounded-pill shadow' type='button'>More details</button></a>
           </div>
           </div>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light rounded-pill mt-3"  >
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="d-flex align-items-center rounded-pill ">
	...
	<div class="row flex-lg-row-reverse align-items-center g-5 py-5">
		...
		<div class="col-lg-6">
			...
			<div class="lc-block d-grid gap-2 d-md-flex justify-content-md-start">
				<a class="btn btn-outline-secondary px-4 rounded-pill" href="contact.php" role="button">Contact Us</a>
			</div>
   ...
   <div class="row mb-4">
      <div class="lc-block text-center">
         <div editable="rich">
            <h2 class="fw-bold fs-2 display-2">Animals for adoption</h2>
         </div>
      </div>
      <div class="lc-block ">
         ...
         <div editable="rich">
            <h2 class="fw-bold fs-2 text-start mt-5 display-2">Featured Pets</h2>
         </div>
      </div>
   </div>
   <div class="row">
